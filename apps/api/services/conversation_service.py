...
async def generate_assistant_response(
    pdf_content: str, conversation_history: List[Message], user_message: str
) -> str:
    """
    ...
    if "summary" in message_lower or "summarize" in message_lower:
        ...
        or "what are" in message_lower
        or "what does" in message_lower
    ):
        ...
        keyword in message_lower for keyword in ["hello", "hi", "hey", "greetings"]
    ):
...
def _extract_relevant_sentence(
    query: str, content_lower: str, original_content: str
) -> str:
...
def _answer_what_question(query: str, content_lower: str, original_content: str) -> str:
    ...
    relevant_sentence = _extract_relevant_sentence(
        query, content_lower, original_content
    )
...
def _answer_how_question(query: str, content_lower: str, original_content: str) -> str:
    ...
    if relevant_sentence:
        return (
            f"{relevant_sentence} This explains the process or method you asked about."
        )
